...
class Redoublements2emeFixtures extends Fixture implements DependentFixtureInterface
{
        ...
        foreach ($niveaux as $niveau) {
            ...
            foreach ($scolarites1 as $scolarite1) {
                ...
                foreach ($scolarites2 as $scolarite2) {
                    ...
                    if ($niveauDesignation === '2ème Année' && $scolaritee1 == 3 && $scolaritee2 == 0) {
                        for ($i = 0; $i < 2; $i++) {
    ...
    {
        return [
            Redoublements1ereFixtures::class
        ];
    }
}
