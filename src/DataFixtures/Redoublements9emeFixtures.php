...
class Redoublements9emeFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($niveaux as $niveau) {
            ...
            $niveau7eme = $this->niveauxRepository->findOneBy(['designation' => '9ème Année']);
            $niveau8eme = $this->niveauxRepository->findOneBy(['designation' => '9ème Année']);
            ...
            foreach ($scolarites1 as $scolarite1) {
                ...
                foreach ($scolarites2 as $scolarite2) {
                    ...
                    if ($niveauDesignation === '9ème Année' && $scolaritee1 == 7 && $scolaritee2 == 3) {
                        for ($i = 0; $i < 6; $i++) {
                    ...
                    } elseif ($niveauDesignation === '9ème Année' && $scolaritee1 == 8 && $scolaritee2 == 3) {
                        for ($i = 0; $i < 6; $i++) {
                            //redoublement 3ème année
                            if ($i == 0) {
                                //1er redoublement 1ère année
    ...
    private function getNiveauByIndex1erCycle(int $index, $niveau1ere, $niveau2eme, $niveau3eme, $niveau4eme, $niveau5eme, $niveau6eme)
    {
        switch ($index) {
            case 0:
                return $niveau1ere;
    ...
    private function getNiveauByIndex1erCyclehors1ereAnnee(int $index, $niveau2eme, $niveau3eme, $niveau4eme, $niveau5eme, $niveau6eme)
    {
        switch ($index) {
            case 0:
                return $niveau2eme;
    ...
    private function getNiveauByIndex1erCyclehors2emeAnnee(int $index, $niveau3eme, $niveau4eme, $niveau5eme, $niveau6eme)
    {
        switch ($index) {
            case 0:
                return $niveau3eme;
    ...
    private function getNiveauByIndex2ndCycle(int $index, $niveau7eme, $niveau8eme, $niveau9eme)
    {
        switch ($index) {
            case 0:
                return $niveau7eme;
    ...
    {
        return [
            Redoublements8emeFixtures::class
        ];
    }
}
