...
class Redoublements5emeFixtures extends Fixture implements DependentFixtureInterface
{
        ...
        foreach ($niveaux as $niveau) {
            ...
            foreach ($scolarites1 as $scolarite1) {
                ...
                foreach ($scolarites2 as $scolarite2) {
                    ...
                    if ($niveauDesignation === '5ème Année' && $scolaritee1 == 6 && $scolaritee2 == 0) {
                        for ($i = 0; $i < 5; $i++) {
    ...
    {
        return [
            Redoublements4emefixtures::class
        ];
    }
}
