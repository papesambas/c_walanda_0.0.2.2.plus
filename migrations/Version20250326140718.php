 ...
 */
final class Version20250326140718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ecole_provenances (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, telephone VARCHAR(25) DEFAULT NULL, email VARCHAR(180) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, designation VARCHAR(130) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(128) NOT NULL, UNIQUE INDEX UNIQ_59378F8CE7927C74 (email), INDEX IDX_59378F8CB03A8386 (created_by_id), INDEX IDX_59378F8C896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE eleves (id INT AUTO_INCREMENT NOT NULL, nom_id INT NOT NULL, prenom_id INT NOT NULL, lieu_naissance_id INT NOT NULL, parent_id INT NOT NULL, classe_id INT NOT NULL, statut_id INT NOT NULL, scolarite1_id INT DEFAULT NULL, scolarite2_id INT DEFAULT NULL, redoublement1_id INT DEFAULT NULL, redoublement2_id INT DEFAULT NULL, redoublement3_id INT DEFAULT NULL, ecole_recrutement_id INT NOT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, sexe VARCHAR(1) NOT NULL, date_inscription DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_recrutement DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_naissance DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_extrait DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', numero_extrait VARCHAR(30) NOT NULL, is_actif TINYINT(1) NOT NULL, is_allowed TINYINT(1) NOT NULL, is_admis TINYINT(1) NOT NULL, is_handicap TINYINT(1) NOT NULL, nature_handicape VARCHAR(255) DEFAULT NULL, fullname VARCHAR(255) DEFAULT NULL, statut_finance VARCHAR(1) NOT NULL, matricule VARCHAR(30) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(128) NOT NULL, UNIQUE INDEX UNIQ_383B09B12E1C7F5 (numero_extrait), INDEX IDX_383B09B1C8121CE9 (nom_id), INDEX IDX_383B09B158819F9E (prenom_id), INDEX IDX_383B09B138C8067D (lieu_naissance_id), INDEX IDX_383B09B1727ACA70 (parent_id), INDEX IDX_383B09B18F5EA509 (classe_id), INDEX IDX_383B09B1F6203804 (statut_id), INDEX IDX_383B09B1F4C45000 (scolarite1_id), INDEX IDX_383B09B1E671FFEE (scolarite2_id), INDEX IDX_383B09B16D13ADFD (redoublement1_id), INDEX IDX_383B09B17FA60213 (redoublement2_id), INDEX IDX_383B09B1C71A6576 (redoublement3_id), INDEX IDX_383B09B180BDEBFF (ecole_recrutement_id), INDEX IDX_383B09B1B03A8386 (created_by_id), INDEX IDX_383B09B1896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE eleves_ecole_provenances (eleves_id INT NOT NULL, ecole_provenances_id INT NOT NULL, INDEX IDX_6E150AF1C2140342 (eleves_id), INDEX IDX_6E150AF18AC80606 (ecole_provenances_id), PRIMARY KEY(eleves_id, ecole_provenances_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, etablissement_id INT DEFAULT NULL, eleve_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(60) NOT NULL, prenom VARCHAR(70) NOT NULL, email VARCHAR(130) NOT NULL, is_verified TINYINT(1) NOT NULL, fullname VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(128) NOT NULL, INDEX IDX_1483A5E9FF631228 (etablissement_id), UNIQUE INDEX UNIQ_1483A5E9A6CC7B2 (eleve_id), INDEX IDX_1483A5E9B03A8386 (created_by_id), INDEX IDX_1483A5E9896DBBDE (updated_by_id), UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE eleves ADD CONSTRAINT FK_383B09B18F5EA509 FOREIGN KEY (classe_id) REFERENCES classes (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE eleves_ecole_provenances ADD CONSTRAINT FK_6E150AF1C2140342 FOREIGN KEY (eleves_id) REFERENCES eleves (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE eleves_ecole_provenances ADD CONSTRAINT FK_6E150AF18AC80606 FOREIGN KEY (ecole_provenances_id) REFERENCES ecole_provenances (id) ON DELETE CASCADE');
