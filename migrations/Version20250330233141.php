 ...
 */
final class Version20250330233141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE retards ADD heure_classe TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\'');
    }
