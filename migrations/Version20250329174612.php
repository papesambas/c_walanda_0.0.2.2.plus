 ...
 */
final class Version20250329174612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annee_scolaires DROP created_by_id, DROP updated_by_id, DROP created_at, DROP updated_at, DROP is_current');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annee_scolaires ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD is_current TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE annee_scolaires ADD CONSTRAINT FK_B7252347896DBBDE FOREIGN KEY (updated_by_id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE annee_scolaires ADD CONSTRAINT FK_B7252347B03A8386 FOREIGN KEY (created_by_id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
