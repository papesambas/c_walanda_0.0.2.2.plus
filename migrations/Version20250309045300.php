 ...
 */
final class Version20250309045300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classes (id INT AUTO_INCREMENT NOT NULL, niveau_id INT NOT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, capacite INT NOT NULL, effectif INT NOT NULL, disponibilite INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', designation VARCHAR(130) NOT NULL, slug VARCHAR(128) NOT NULL, INDEX IDX_2ED7EC5B3E9C81 (niveau_id), INDEX IDX_2ED7EC5B03A8386 (created_by_id), INDEX IDX_2ED7EC5896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE eleves (id INT AUTO_INCREMENT NOT NULL, nom_id INT NOT NULL, prenom_id INT NOT NULL, lieu_naissance_id INT NOT NULL, parent_id INT NOT NULL, user_id INT NOT NULL, classe_id INT NOT NULL, statut_id INT NOT NULL, sexe VARCHAR(1) NOT NULL, date_inscription DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_recrutement DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_naissance DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_extrait DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', numero_extrait VARCHAR(30) NOT NULL, is_actif TINYINT(1) NOT NULL, is_allowed TINYINT(1) NOT NULL, is_admin TINYINT(1) NOT NULL, is_handicap TINYINT(1) NOT NULL, nature_handicape VARCHAR(255) DEFAULT NULL, fullname VARCHAR(255) DEFAULT NULL, statut_finance VARCHAR(1) NOT NULL, UNIQUE INDEX UNIQ_383B09B12E1C7F5 (numero_extrait), INDEX IDX_383B09B1C8121CE9 (nom_id), INDEX IDX_383B09B158819F9E (prenom_id), INDEX IDX_383B09B138C8067D (lieu_naissance_id), INDEX IDX_383B09B1727ACA70 (parent_id), INDEX IDX_383B09B1A76ED395 (user_id), INDEX IDX_383B09B18F5EA509 (classe_id), INDEX IDX_383B09B1F6203804 (statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
